...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/flatsurf-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/flatsurf-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libflatsurf pyflatsurf
# for installing globally
pixi global install libflatsurf pyflatsurf
```
...
It is possible to list all of the versions of `libflatsurf` available on your platform:
...
```
pixi search libflatsurf --channel conda-forge
```
